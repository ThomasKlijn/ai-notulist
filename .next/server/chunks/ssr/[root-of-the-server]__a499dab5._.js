...
"[project]/server/elevenlabs.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/server/openai.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$elevenlabs$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/elevenlabs.ts [app-rsc] (ecmascript)");
;
// Using GPT-4o which is the most capable model currently available
const openai = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"]({
...
async function transcribeAudio(audioBuffer, language = 'nl') {
    try {
        ...
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$elevenlabs$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["transcribeAudioWithElevenLabs"])(audioBuffer, language);
...
"[project]/server/processingService.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$openai$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/openai.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$elevenlabs$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/elevenlabs.ts [app-rsc] (ecmascript)");
...
class MeetingProcessingService {
    ...
    async doProcessMeeting(meetingId) {
        try {
            ...
            // Get meeting details
            const meeting = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].getMeetingWithAttendees(meetingId);
            if (!meeting) {
            ...
            if (!meeting.organizerConsentGiven || !meeting.allAttendeesConsented || meeting.status === 'cancelled') {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].updateMeeting(meetingId, {
                    status: 'failed',
                    summary: {
            ...
            const consentCheck1 = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].getMeeting(meetingId);
            ...
            if (speakers.length > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].addSpeakers(meetingId, speakers.map((speaker)=>({
            ...
            const consentCheck2 = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].getMeeting(meetingId);
            ...
            const summary = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$openai$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateMeetingSummary"])(transcription, meeting.title, meeting.language || 'nl');
            ...
            const consentCheck3 = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].getMeeting(meetingId);
            ...
            const meetingWithSpeakers = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].getMeetingWithAttendees(meetingId);
            ...
            for (const chunkFile of chunkFiles){
                if (chunkFile && __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["existsSync"](chunkFile.filePath)) {
                    try {
                        ...
                        const consentCheck = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].getMeeting(meetingId);
                        ...
                        const chunkResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$elevenlabs$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["transcribeWithSpeakerAnalysis"])(chunkBuffer, language);
    ...
    async runAutoCleanup() {
        try {
            ...
            const meetings = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].getMeetingsForCleanup();
            let cleanedCount = 0;
            for (const meeting of meetings){
                ...
                if (meeting.createdAt <= cutoffDate) {
                    ...
                    try {
                        ...
                        await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].cleanupMeeting(meeting.id);
                        cleanedCount++;
                        ...
                        await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].updateLastCleanup(meeting.id);
                    }
                } else {
    ...
    async manualCleanupMeeting(meetingId) {
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["storage"].cleanupMeeting(meetingId);
    ...
    async sendEmailSummary(meeting, transcription, summary) {
        try {
            ...
            const { emailService } = await __turbopack_context__.A("[project]/server/emailService.ts [app-rsc] (ecmascript, async loader)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a499dab5._.js.map