...
"[project]/server/emailService.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sendgrid$2f$mail$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sendgrid/mail/index.js [app-rsc] (ecmascript)");
;
if (!process.env.SENDGRID_API_KEY) {
    throw new Error("SENDGRID_API_KEY environment variable must be set");
}
const mailService = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sendgrid$2f$mail$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MailService"]();
        ...
        try {
            ...
            const emailPromises = attendees.map((attendee, index)=>{
                ...
                return mailService.send({
                    to: attendee.email,
                    from: process.env.VERIFIED_SENDER_EMAIL || 'test@yourdomain.com',
                    subject: subject,
                    text: textContent,
                    html: htmlContent
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6253b704._.js.map